...
class Fb_ignited
{
	...
	function fb_is_liked()
	{
		...
		if(is_array($request)):
			if(!isset($request['page'])): return 'redirect';
			elseif(isset($request['page']) && $request['page']['liked']): return true;
			else: return false;
			endif;
	...
	private function fb_set_globals($params)
	{
		 ...
		 */
		if (is_string($params['fb_page']))
		{
			$param_array['page'] = $this->globals['fb_page'] = $params['fb_page'];			
		}
