<!DOCTYPE html>
<head>
	<title>Tetley's Tea Plucker Challenge</title>
	...
	<script type="text/javascript">
		...
		function shareTwitter(){
			...
			var url = "<?php echo urlencode("http://apps.facebook.com/milupaclickandwin"); ?>";
		...
		function shareFacebook(){
			FB.ui({
				method: 'feed',
				display: 'dialog',
				name: 'Bist du schnell genug, um [Preis] zu gewinnen?',
				...
				description: 'Spiele jetzt und probiere aus, wie viele Abfolgen du innerhalb von 60 Sekunden richtig wiederholen kannst. Du hast die Chance auf tägliche Sofortgewinne!',
